...
<div align="center">
	...
	<form:form modelAttribute="user" action="/getAgentDetails" method="POST">
		...
		<tr>
				...
				<td><b><h2><form:input path="userId" name="userId"
						value="${item.userId}"/></h2></b></td>
				<td><form:errors path="userId" /></td>
			</tr>
			<tr>
				<td><b><h2>Name</h2></b></td>
				<td><b><h2><form:input path="firstName" name="firstName" value="${item.firstName}"></form:input></h2></b></td>
				<td><form:errors path="firstName"></form:errors></td>
			</tr>
			<tr>
				<td><b><h2>Email</h2></b></td>
				<td><b><h2><form:input path="email" name="email"
						value="${item.email}"  /></h2></b></td>
				<td><form:errors path="email" /></td>
			</tr>
			<tr>
				<td><b><h2>Mobile Number</h2></b></td>
				<td><b><h2><form:input path="contact" type="text" name="contact"
						value="${item.contact}" /></h2></b></td>
