	...
	<div class="container-fluid ">
		<div class="container" style="margin-top: 100px">
			...
			<div align="center" style="color: white">
				<h5
					class=" display-4 card-header success-color white-text text-center py-4">
					<strong>Enter the Security Answers for a Recovery Password</strong>
				</h5>
			</div>
			<br> <br>
			<form:form action="/forgotPassword" method="POST" name="userRegister"
				modelAttribute="user" class="col-md-20 w-100">
				<table>
				...
				<center>
					<button
						class="btn btn-warning  btn-rounded btn-small navbar-btn text-dark"
