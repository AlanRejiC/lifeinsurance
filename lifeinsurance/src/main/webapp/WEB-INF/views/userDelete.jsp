...
<center>
<h1 style="color:white; font-size: 80px">The User has been deleted</h1>
<br>
<a class="btn btn-info btn-lg active navbar-btn text-white font-weight-bold" 
					 href="/getUserPage?role=All">Go to User Menu</a>
</center>
