		...
		<form:form action="/getClaimPage" method="POST" name="userRegister"
			...
			<div class="md-form text-white">
					...
					<form:input path="custName" type="text"
							name="custName" class="form-control" value="${item.custName}"/>
			...
			<div class="md-form text-white">
					...
					<form:input path="incurredDate" type="text"
							name="incurredDate" class="form-control" value="${item.incurredDate}" />
			...
			<div class="md-form text-white">
					...
					<form:input path="reportedDate" type="text"
							name="reportedDate" class="form-control" value="${item.reportedDate}" />
			...
			<div class="md-form text-white">
					...
					<form:input path="datePaid" type="text" name="datePaid" class="form-control" value="${item.datePaid}" />
			...
			<div class="md-form text-white">
					...
					<form:input path="admitDate" type="text" name="admitDate" class="form-control" value="${item.admitDate}" />
			...
			<div class="md-form text-white">
					...
					<form:input path="releaseDate" type="text"
							name="releaseDate" class="form-control" value="${item.releaseDate}" />
			...
			<div class="md-form text-white">
					...
					<form:input path="totalCharge" name="totalCharge" class="form-control" value="${item.totalCharge}" />
			...
			<div class="md-form text-white">
					...
					<form:input path="preCharge" name="preCharge" class="form-control" value="${item.preCharge}"/>
			...
			<div class="md-form text-white">
					...
					<form:input path="postCharge" name="postCharge" class="form-control" value="${item.postCharge}" />
