...
public class FeedBackController {
	...
	@Autowired
	 ...
	 @PostMapping(value = "/getFeedBackPage")
	    public String postFeedBackPage(@ModelAttribute("questionnaire") Questionnaire questionnaire,BindingResult result, ModelMap map) {
		 
		try {
				if (userService.findUser(questionnaire.getUserId()) != null) {
