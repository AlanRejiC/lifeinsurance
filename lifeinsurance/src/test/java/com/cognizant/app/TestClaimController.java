...
//	@Test
//	public void testreSubmitClaimPage() throws Exception{
//		this.mockMvc.perform(MockMvcRequestBuilders.post("/getClaimEdit")).andExpect(status().is2xxSuccessful());
//	}

	@Test
	public void testGetEditClaimPage() throws Exception {
		
		this.mockMvc.perform(get("/getClaimEdit")   
				.param("claimNumber", "1236"))
		.andExpect(view().name("claimedit"));
